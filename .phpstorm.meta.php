...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\si-masjid\public\storage' => 'string',
            'intervention-image.driver' => 'string',
            'intervention-image.options.autoOrientation' => 'boolean',
            'intervention-image.options.decodeAnimation' => 'boolean',
            'intervention-image.options.backgroundColor' => 'string',
            'intervention-image.options.strip' => 'boolean',
            ...
            'midtrans.is_sanitized' => 'boolean',
            'midtrans.is_3ds' => 'boolean',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\si-masjid\\public\\storage',
'intervention-image.driver','intervention-image.options.autoOrientation','intervention-image.options.decodeAnimation','intervention-image.options.backgroundColor','intervention-image.options.strip',
...
'mail.markdown.theme','mail.markdown.paths','mail.markdown.extensions','midtrans.server_key','midtrans.client_key',
'midtrans.is_production','midtrans.is_sanitized','midtrans.is_3ds','permission.models.permission','permission.models.role',
...
'permission.cache.expiration_time','permission.cache.key','permission.cache.store','purifier.encoding','purifier.finalize',
...
'purifier.settings.youtube.URI.SafeIframeRegexp','purifier.settings.custom_definition.id','purifier.settings.custom_definition.rev','purifier.settings.custom_definition.debug','purifier.settings.custom_definition.elements',
...
'purifier.settings.custom_definition.elements.10.4.preload','purifier.settings.custom_definition.elements.10.4.controls','purifier.settings.custom_definition.elements.11.4.src','purifier.settings.custom_definition.elements.11.4.type','purifier.settings.custom_definition.elements.18.4.cite',
'purifier.settings.custom_definition.elements.18.4.datetime','purifier.settings.custom_definition.elements.19.4.cite','purifier.settings.custom_definition.elements.19.4.datetime','purifier.settings.custom_definition.attributes','purifier.settings.custom_attributes',
'purifier.settings.custom_elements','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'permission','role_or_permission',);
        registerArgumentsSet('routes', 'api.prayer.times','api.prayer.refresh','api.prayer.cities','home',
'public.committees.index','public.articles.index','public.articles.show','public.events.index','public.events.show',
'public.events.calendar','public.events.calendar-data','public.qurban.index','public.qurban.show','public.infaq.index',
'public.zakat.index','public.zakat.calculator','auth.google','auth.google.callback','webhook.midtrans',
...
'dashboard','public.infaq.store','public.infaq.history','public.infaq.pay','public.infaq.receipt',
'public.infaq.upload-proof','public.zakat.store','public.zakat.history','public.zakat.pay','public.zakat.receipt',
'public.zakat.upload-proof','public.qurban.orders.create','public.qurban.orders.store','public.qurban.orders.history','public.qurban.orders.pay',
'public.qurban.orders.receipt','public.qurban.orders.upload-proof','public.qurban.orders.certificate','profile.edit','profile.update',
'profile.destroy','admin.dashboard','admin.donation-dashboard.index','admin.qurban-dashboard.index','admin.mosque-profile.edit',
'admin.mosque-profile.update','admin.committees.index','admin.committees.create','admin.committees.store','admin.committees.edit',
'admin.committees.update','admin.committees.destroy','admin.article-categories.index','admin.article-categories.create','admin.article-categories.store',
'admin.article-categories.edit','admin.article-categories.update','admin.article-categories.destroy','admin.event-categories.index','admin.event-categories.create',
'admin.event-categories.store','admin.event-categories.edit','admin.event-categories.update','admin.event-categories.destroy','admin.articles.trash',
'admin.articles.restore','admin.articles.force-delete','admin.articles.index','admin.articles.create','admin.articles.store',
'admin.articles.edit','admin.articles.update','admin.articles.destroy','admin.events.index','admin.events.create',
'admin.events.store','admin.events.edit','admin.events.update','admin.events.destroy','admin.events.documentations.store',
'admin.events.documentations.destroy','admin.sacrificial-animals.index','admin.sacrificial-animals.create','admin.sacrificial-animals.store','admin.sacrificial-animals.edit',
'admin.sacrificial-animals.update','admin.sacrificial-animals.destroy','admin.sacrificial-animals.documentations.store','admin.sacrificial-animals.documentations.destroy','admin.qurban-verifications.index',
'admin.qurban-verifications.show','admin.qurban-verifications.approve','admin.qurban-verifications.reject','admin.infaq-categories.index','admin.infaq-categories.create',
'admin.infaq-categories.store','admin.infaq-categories.edit','admin.infaq-categories.update','admin.infaq-categories.destroy','admin.infaq-campaigns.index',
'admin.infaq-campaigns.create','admin.infaq-campaigns.store','admin.infaq-campaigns.edit','admin.infaq-campaigns.update','admin.infaq-campaigns.destroy',
'admin.infaqs.index','admin.infaqs.show','admin.zakat-types.index','admin.zakat-types.create','admin.zakat-types.store',
'admin.zakat-types.edit','admin.zakat-types.update','admin.zakat-types.destroy','admin.zakats.index','admin.zakats.show',
'admin.donation-verifications.infaq.index','admin.donation-verifications.infaq.show','admin.donation-verifications.infaq.approve','admin.donation-verifications.infaq.reject','admin.donation-verifications.zakat.index',
'admin.donation-verifications.zakat.show','admin.donation-verifications.zakat.approve','admin.donation-verifications.zakat.reject','admin.reports.index','admin.reports.export-excel',
'admin.reports.export-pdf','admin.reports.export-csv','admin.audit-trail.index','admin.donation-settings.edit','admin.donation-settings.update','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.article-categories.create','admin.article-categories.edit','admin.article-categories.index','admin.articles._form','admin.articles.create',
'admin.articles.edit','admin.articles.index','admin.articles.trash','admin.audit-trail.index','admin.committees._form',
'admin.committees.create','admin.committees.edit','admin.committees.index','admin.dashboard','admin.donation-dashboard.index',
'admin.donation-settings.edit','admin.donation-verifications.infaq-index','admin.donation-verifications.infaq-show','admin.donation-verifications.zakat-index','admin.donation-verifications.zakat-show',
'admin.event-categories.create','admin.event-categories.edit','admin.event-categories.index','admin.events._form','admin.events.create',
'admin.events.edit','admin.events.index','admin.infaq-campaigns._form','admin.infaq-campaigns.create','admin.infaq-campaigns.edit',
'admin.infaq-campaigns.index','admin.infaq-categories.create','admin.infaq-categories.edit','admin.infaq-categories.index','admin.infaqs.index',
'admin.mosque-profile.edit','admin.partials.sidebar','admin.qurban-dashboard.index','admin.qurban-verifications.index','admin.qurban-verifications.show',
'admin.reports.index','admin.sacrificial-animals._form','admin.sacrificial-animals.create','admin.sacrificial-animals.edit','admin.sacrificial-animals.index',
'admin.zakat-types._form','admin.zakat-types.create','admin.zakat-types.edit','admin.zakat-types.index','admin.zakats.index',
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.verify-email','components.admin-nav-icon','components.application-logo','components.auth-session-status','components.breadcrumb',
'components.button','components.card','components.checkbox','components.confirm-modal','components.danger-button',
'components.delete-form','components.dropdown','components.dropdown-link','components.empty-state','components.error-page',
'components.guest-layout','components.input-error','components.input-label','components.modal','components.nav-link',
'components.page-header','components.primary-button','components.quota-progress','components.responsive-nav-link','components.secondary-button',
'components.section-heading','components.sortable-header','components.text-input','components.toast','errors.403',
'errors.404','errors.419','errors.500','layouts.admin','layouts.app',
'layouts.guest','layouts.partials.back-to-top','layouts.partials.floating-prayer','layouts.partials.footer','layouts.partials.navbar',
'pdf.donation.receipt','pdf.financial-report','pdf.infaq-receipt','pdf.qurban-certificate','pdf.qurban.receipt',
'pdf.zakat-receipt','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
'public.articles._share-buttons','public.articles.index','public.articles.show','public.committees.index','public.events._map',
'public.events._share-buttons','public.events.calendar','public.events.index','public.events.show','public.home',
'public.infaq.campaign','public.infaq.history','public.infaq.index','public.infaq.pay','public.qurban.index',
'public.qurban.orders.create','public.qurban.orders.history','public.qurban.orders.pay','public.qurban.show','public.zakat.calculator',
'public.zakat.history','public.zakat.index','public.zakat.pay','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.base64','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid',
'C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.laragon.www.si-masjid.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name','auth.failed','auth.password','auth.throttle',
...
'APP_TIMEZONE','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','LOG_CHANNEL',
...
'FILESYSTEM_DISK','QUEUE_CONNECTION','CACHE_STORE','MAIL_MAILER','MAIL_SCHEME',
'MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD','MAIL_ENCRYPTION',
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI',
'MIDTRANS_MERCHANT_ID','MIDTRANS_SERVER_KEY','MIDTRANS_CLIENT_KEY','MIDTRANS_IS_PRODUCTION','MIDTRANS_SANITIZED',
'MIDTRANS_3DS','PRAYER_TIME_CITY_ID','PRAYER_CITY_CODE',);
