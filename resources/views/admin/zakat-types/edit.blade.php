...
@section('content')
    <div class="mx-auto max-w-2xl">
        <div class="mb-6 flex items-center gap-4">
            ...
            <div>
                <h2 class="text-xl font-semibold text-gray-800">Ubah Jenis Zakat</h2>
                <p class="text-sm text-gray-500">Perbarui informasi dan cara perhitungan jenis zakat</p>
            </div>
        </div>
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm shadow-gray-200/60">
            <div
                ...
                <p class="text-sm text-gray-600">Perubahan cara perhitungan akan berlaku untuk transaksi berikutnya.</p>
            </div>

            <form method="POST" action="{{ route('admin.zakat-types.update', $zakatType) }}" class="p-8">
