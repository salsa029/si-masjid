    ...
    <div class="mx-auto max-w-2xl">
        <div class="mb-6 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Buat akun jamaah atau admin baru</p>
            </div>
        </div>
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm shadow-gray-200/60">
            <div
                ...
                <p class="text-sm text-gray-600">Akun dengan role Admin langsung punya akses ke Admin Panel ini.</p>
            </div>
