...
<div class="mb-2">
    ...
    <input type="text" name="name" id="name" value="{{ old('name', $infaqCategory->name ?? '') }}"
        ...
        placeholder="Misal: Pembangunan, Yatim Piatu, Bencana Alam">
    @error('name')
...
<div class="mt-8 flex items-center gap-3 border-t border-gray-100 pt-6">
    <button type="submit"
        ...
        <i class="fas fa-save"></i> {{ isset($infaqCategory) ? 'Simpan Perubahan' : 'Simpan' }}
    </button>
