...
@section('content')
    <div class="mx-auto max-w-2xl">
        <div class="mb-6 flex items-center gap-4">
            ...
            <div>
                <h2 class="text-xl font-semibold text-gray-800">Ubah Kategori Infaq</h2>
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm shadow-gray-200/60">
            <div
                ...
                <p class="text-sm text-gray-600">Perubahan nama akan memperbarui data kategori.</p>
            </div>

            <form method="POST" action="{{ route('admin.infaq-categories.update', $infaqCategory) }}" class="p-8">
