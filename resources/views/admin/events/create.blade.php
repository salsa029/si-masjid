...
@section('content')
    <div class="mx-auto max-w-3xl">
        <div class="mb-6 flex items-center gap-4">
            ...
            <div>
                <h2 class="text-xl font-semibold text-gray-800">Tambah Kegiatan</h2>
                <p class="text-sm text-gray-500">Buat kegiatan baru untuk ditampilkan di Galeri Kegiatan</p>
            </div>
        </div>
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm shadow-gray-200/60">
            <div
                ...
                <p class="text-sm text-gray-600">Lengkapi detail kegiatan, lalu simpan sebagai draf atau publikasikan.</p>
            </div>

            <form method="POST" action="{{ route('admin.events.store') }}" enctype="multipart/form-data" class="p-8">
