{{-- resources/views/admin/committees/create.blade.php --}}
...
@section('content')
    <div class="mx-auto max-w-2xl">
        <div class="mb-6 flex items-center gap-4">
            ...
            <div>
                <h2 class="text-xl font-semibold text-gray-800">Tambah Pengurus</h2>
                <p class="text-sm text-gray-500">Lengkapi data pengurus masjid</p>
            </div>
        </div>
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm shadow-gray-200/60">
            <div
                ...
                <p class="text-sm text-gray-600">Data ini akan tampil pada halaman profil pengurus di website publik.</p>
            </div>
