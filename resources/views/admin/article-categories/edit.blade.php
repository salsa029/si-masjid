...
@section('content')
    <div class="mx-auto max-w-2xl">
        <div class="mb-6 flex items-center gap-4">
            ...
            <div>
                <h2 class="text-xl font-semibold text-gray-800">Ubah Kategori</h2>
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm shadow-gray-200/60">
            ...
            <form method="POST" action="{{ route('admin.article-categories.update', $articleCategory) }}" class="p-8">
                @csrf
                @method('PUT')
                <div class="mb-2">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $articleCategory->name) }}"
                        ...
                        placeholder="Misal: Kajian, Berita, Pengumuman">
                    @error('name')
